...
def clean_data(base_dir):
    treeshapy_dir = os.path.join("../data", base_dir, "treeshapy")
    clean_dir = os.path.join("../data", base_dir, "treeshapy_clean")
    ...
    shutil.move(treeshapy_dir, os.path.join("../data/", base_dir, "treeshapy_old"))
    shutil.move(clean_dir, treeshapy_dir)

for base_dir in ["grove", "grove_modificated"]:
    clean_data(base_dir)
